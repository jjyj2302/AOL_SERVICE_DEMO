...
class ThreatHuntingCrew():
    ...
    def malware_analysis(self) -> Task:
        ...
        return Task(
            ...
            context=[self.initial_assessment()],
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m app.features.deep_analysis.crew <IOC>")
        print("\nExamples:")
        print("  python -m app.features.deep_analysis.crew rtmp.blog")
        print("  python -m app.features.deep_analysis.crew 8.8.8.8")
        print("  python -m app.features.deep_analysis.crew 44d88612fea8a8f36de82e1278abb02f")
        sys.exit(1)
